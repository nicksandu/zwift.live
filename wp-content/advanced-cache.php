...
$possible_plugin_locations = array(
	...
	'C:\wamp64\www\zwift.live\wp-content\plugins\wp-optimize\cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\wamp64\www\zwift.live\wp-content\plugins\wp-optimize\cache/extensions');
}
